...
use Drupal\dkan_catalog_ui_preview\ImportStatusMessage;
 ...
 * Test case.
 */
#[CoversClass(\Drupal\dkan_catalog_ui_preview\ImportStatusMessage::class)]
...
class ImportStatusMessageTest extends UnitTestCase {
  ...
  public function testBuildStructure(): void {
    ...
    $this->assertSame(['dcu-table__message'], $build['#attributes']['class']);
